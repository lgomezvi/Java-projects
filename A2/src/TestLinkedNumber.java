...
public class TestLinkedNumber {
    ...
    private static boolean test09() {
        ...
        // System.out.println("B3 " + b3 + " " + ln.toString());

        ln.addDigit(new Digit('3'), 1);

        boolean b4 = ln.toString().equals("5AB9CD37");

        //System.out.println("B4 " + b3 + " " + ln.toString());
    ...
    private static boolean test10() {
        ...
        //System.out.println("b1 " + b1 + " " + ln.toString() + " Val: " + v1 + "=" + 6291456);

        int v2 = ln.removeDigit(0);

        boolean b2 = ln.toString().equals("217526");

        //System.out.println("b2 " + b2 + " " + ln.toString() + "=" + 217526 + " Val: " + v2 + "=" + 7);

        int v3 = ln.removeDigit(3);

        boolean b3 = ln.toString().equals("21526");
        
        //System.out.println("b3 " + b3 + " " + ln.toString() + "=" + 21526 +  " Val: " + v3 + "=" + 3584);
        ...
        //System.out.println("rear" + ln.getRear().getElement());

        //System.out.print("f: " + f + " b: " + b + " b1: " + b1 + " b2: " + b2 + " b3: " + b3 + " b4: " + b4 + " b5: " + b5 + " b6: " + b6 + "\n");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Test 10 Failed (exception)" + e);
        }
